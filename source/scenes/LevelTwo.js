class LevelTwo extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('diamondOutline', 'assets/diamondOutline.png');
        this.load.image('diamondStamp', 'assets/diamondStamp.png');
    ...
    create() {
        ...
        this.spot1 = this.add.image(200, 280, 'diamondOutline');
        this.spot2 = this.add.image(170, 220, 'diamondOutline');
        this.spot3 = this.add.image(170, 340, 'diamondOutline');
        this.spot4 = this.add.image(440, 150, 'diamondOutline');
        this.spot5 = this.add.image(470, 90, 'diamondOutline');
        this.spot6 = this.add.image(470, 210, 'diamondOutline');

        this.input.on('pointerdown', function (pointer) {

            console.log('down');
    
            this.stamp = this.add.image(pointer.x, pointer.y, 'diamondStamp');
    ...
    update() {
        ...
        if (this.counter == 6){
            ...
            var nextLevel = this.add.sprite(200, 350, 'NextLevelButton').setInteractive();
